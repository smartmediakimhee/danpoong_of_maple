 ...
 --%>
	<div class="container">
		...
		<button type="button" class="btn btn-info btn-lg" data-toggle="modal"
			data-target="#myModal" style="height: 500px; width: 200px; border: 0px solid black; background-image: url('images/02_0002.png'); background-repeat: no-repeat; background-size: cover;"></button>
		</div>
