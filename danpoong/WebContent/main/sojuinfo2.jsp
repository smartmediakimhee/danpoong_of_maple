	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content" style="border: 3px solid green;">
				...
				<div style="border: 3px solid black; height: 300px; width: 60%;"
					id="border1"></div>
				<div style="border: 3px solid black; height: 300px; width: 38%;"
					id="border2">
					<table align="center">
						
						<tr align="center" style="border-bottom: 1px solid black; height: 73px;">
